...
export default function ItemCard({ items, users, rentals, activeFilters, t, lang }: { items: Item[], users: any, rentals: any, activeFilters: { [key: string]: string }, lang: any, t: any }) {
