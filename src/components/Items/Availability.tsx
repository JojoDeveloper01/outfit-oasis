...
const Availability: FunctionalComponent<{ entry: Entry }> = ({ entry }) => {
    ...
    return (
        <div
            ...
            className={`absolute top-[.7vw] left-2 px-[.8vw] py-[.3vw] text-[.7vw] max-[464px]:text-[1.5vw] max-[464px]:px-[4vw] max-[464px]:py-[1.3vw] font-bold uppercase rounded-lg z-10 ${lastUnavailableDate ? "bg-[--gold] text-black" : "bg-[--greenBlack] text-white"
                }`}
